...
export default function Welcome({contentToShow}:{contentToShow: Boolean}) {
  return (
    <>
      <section className={`w-full md:w-8/12 lg:w-1/2 xl:w-1/3 bg-darkest-blue text p-8 flex ${ contentToShow? 'justify-between' : '' } text-white flex-col overflow-hidden md:py-16 relative z-[100]`}>
